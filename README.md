...
- `nvm install --lts` (`node -v` v20.12.2)
- `npm i`
...
- [WORK IN A TEAM](https://github.com/mate-academy/react_task-guideline/blob/master/team-flow.md#how-to-work-in-a-team)
- [DEMO LINK](https://fs-jan24-midnight-coup.github.io/react_phone-catalog) and add it to the PR description.
